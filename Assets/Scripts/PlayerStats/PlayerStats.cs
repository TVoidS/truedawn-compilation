...
public static class PlayerStats
{
    ...
    public static void setup(GameObject gameObject, TextMeshProUGUI qiCountDisplay, TextMeshProUGUI slagCount, TextMeshProUGUI sysDisp) 
    {
        // Load Player Data
        QiCount.Initiate(10, qiCountDisplay, 10);
        SystemPointsCount.Initiate(sysDisp, 0);
        SlagCount.Initiate(slagCount, 0);
